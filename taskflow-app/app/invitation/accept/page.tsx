...
export default function AcceptInvitationPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-blue-50 flex items-center justify-center p-6 relative overflow-hidden">
            {/* Animated background elements */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-40 -left-40 w-80 h-80 bg-indigo-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob"></div>
                <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000"></div>
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-10 max-w-md w-full border-2 border-gray-200 text-center shadow-2xl relative z-10">
                {status === 'loading' && (
                    <>
                        <div className="w-20 h-20 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin mx-auto mb-6"></div>
                        <h1 className="text-3xl font-bold text-gray-900 mb-3">Processing Invitation</h1>
                ...
                {status === 'success' && (
                    <>
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mb-3">Invitation Accepted!</h1>
                ...
                {status === 'error' && (
                    <>
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mb-3">Invitation Failed</h1>
                        <p className="text-gray-600 mb-6 leading-relaxed">{message}</p>
                        <button
                            onClick={() => router.push('/project')}
                            className="bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 mx-auto"
                        >
